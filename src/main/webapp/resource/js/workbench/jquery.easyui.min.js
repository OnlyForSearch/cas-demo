...
var t=$("<a href=\"javascript:void(0)\"></a>").attr('title', !opts.tools[i].tips?"":opts.tools[i].tips).addClass(opts.tools[i].iconCls).appendTo(tool);
if(opts.tools[i].handler){
t.bind("click",opts,eval(opts.tools[i].handler));
}
}
}
}
if(opts.collapsible){
$("<a class=\"panel-tool-collapse\" title=\"收起&展开\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
...
if(opts.minimizable){
$("<a class=\"panel-tool-min\" title=\"最小化\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
_194(_174);
return false;
});
}
if(opts.maximizable){
$("<a class=\"panel-tool-max\" title=\"最大化\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
...
if(opts.closable){
$("<a class=\"panel-tool-close\" title=\"关闭\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
_177(_174);
return false;
});
}
...
if(opts.maximized==true || !opts.onMaximize.call(_192, opts)){
return;
}
...
if(!opts.onMinimize.call(_195)) return;
_196.hide();
opts.minimized=true;
opts.maximized=false;
