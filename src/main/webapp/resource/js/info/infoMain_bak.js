...
/*
  ...
  */
  ...
  form.action=billUrl+"tag="+form.tag.value;
    ...
    /*window.showModalDialog("bill_info_dispatch.htm?billInfoId=" + billInfoId + "&action=ACTION_BOTH&title=" + encodeURIComponent(form.title.value), window, "dialogWidth=340px;dialogHeight=220px;help=0;scroll=0;status=0;");
    form.submit();*/
    form.submit();
  ...
  try{
	...
	if(document.readyState=="complete")
	{
		...
		else
		{
            ...
            if(billInfoId==0){
                //console.log(billInfoForm.content.value);
                //document.getElementById("contentIframe").contentWindow.eWebEditor.window.document.documentElement.innerHTML = billInfoForm.content.value
