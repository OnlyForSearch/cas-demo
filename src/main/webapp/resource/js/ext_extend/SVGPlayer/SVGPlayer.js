 ...
 * Example usage:
<pre>
    var youtubePlayerPanel = new Ext.ux.SVGPlayer({
    ...
    var w = new Ext.Window({
        ...
        bbar : new Ext.ux.SVGPlayer.Control({
 ...
 *
 *
 * @class Ext.ux.SVGPlayer
 * @extends Ext.FlashComponent
 * @author Thorsten Suckow-Homberg <ts@siteartwork.de>
 * @version 0.3
 */
Ext.ux.SVGPlayer = Ext.extend(Ext.FlashComponent, {
    ...
    initComponent : function()
    {
        this.addEvents(
             ...
             * via javascript
             * @param {Ext.ux.SVGPlayer} panel The Ext.BoxComponent derivat holding the flash object
             ...
             */
              ...
              * @param {Ext.ux.SVGPlayer} panel The Ext.BoxComponent that holds the flash player
              * @param {HTMLElement} player The Dom node representing the flash player
              */
              'stateChange',
        ...
        if (!Ext.ux.SVGPlayer.Players) {
            Ext.ux.SVGPlayer.Players = [];
        }
        Ext.ux.SVGPlayer.Players[this.playerId] = this;
    },
...
var _onYouTubePlayerReady = function(playerId) {
    var panel = Ext.ux.SVGPlayer.Players[playerId],
        player,
        stEvent,
        errEvent,
    ...
    if (panel) {
         ...
         *     'onStateChange',
         *     "Ext.ux.SVGPlayer.Players['"+playerId+"']._delegateStateEvent"
         * );
         * does NOT work!
         */
...
if (!window.onYouTubePlayerReady) {
    ...
    throw("\"onYouTubePlayerReady\" is already defined. Cannot use Ext.ux.SVGPlayer.")
}