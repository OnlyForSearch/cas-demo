...
function form(appReqeust)
{
   ...
   var loadDefine= function(oForm)
   {
		...
		function setTable(aCollection)
	    {
	       ...
	       function getTableField(oFieldNode,oElementType,oElement)
	       {
	          ...
	          {                            
	              return oElementType.getText(oElement);
	          };
   ...
   this.flowSubmit=function()
   {
		...
		{
		    return oWin.form.onFlowSubmit(this);
		}
		return true;
   }
   this.onClickBeforeEvent=function()
   {
        if(oWin.form.onClickBefore)
		{
		    return oWin.form.onClickBefore(this);
		}
        return true;
   }
   ...
   var doAfterLoadPrint = function(aPrintParam,formContext,printForm,aPrintType,isSub){
   		if(oFrame.print.readyState=="complete"){
		    ...
		    if (oWin.print.onPrintWord){
		    	oWin.print.onPrintWord(formContext,printForm);
		    }else if(isSub=='T'){
...
form.elementFactory=(function()
{
    function vElement()
    {
       ...
       this.getText=function(oElement){return this.getValue(oElement).replace(/\n/gi,"<br>")};
...
function flowForm(flowRequest)
{
   ...
   function getFlowProcHTML(oForm)
   {
	    var sTable='<div style="visibility:hidden;"><p style="page-break-after:always;"></p></div>'
	               ...
	               +         '<TD>'+formLang.exec_staff+'</TD><TD>' +formLang.tache_context+ '</TD>'
	               +         '<TD>'+formLang.execute_result+'</TD><TD>'+formLang.tch_doc+'</TD><TD>'+formLang.finish_time+'</TD>'
	               +       '</tr>'
