...
(function(factory){
	...
	$.cxColor = function(){
		...
		colorPanel.build = function(){
			...
			var _baseColorHex = ['609022','AA41CD','35909E','3D6AAA','4D53A5','B48E43','C26502','5487ED','B20E0E','E59C00','42AB59','9D569D','955959','AE7841','ABAB4E','EC5105','AB4646','8899AB'];
			var _html = '';
			...
			if(_this.settings.pickerType == 'simple' ){
				for(var i=0;i<_baseColorHex.length;i++){
					if(i==0){
						_html += '<tr>';
					}
					_html += '<td title="#' + _baseColorHex[i] + '" style="background-color:#' + _baseColorHex[i]+'">';
					if(i!=0 && (i+1)%6==0){
						_html += '</tr><tr>';
					}
					if(i==_baseColorHex.length-1)
						_html += '</tr>';
				}
			}else{
				for (var i = 0; i < 2; i++) {
