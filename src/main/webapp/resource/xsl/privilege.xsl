...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!--显示的菜单层数-->
	<xsl:variable name="showDepth" select="100"/>
	<!--图标所在路径-->
									...
									<tr valign="middle">
										...
										<td>
											...
											<div class="icoItem">
												...
												<input type="checkbox" style="height:16px;width:16px" onclick="itmeCheck()" name="checkItem">
													<xsl:attribute name="id">
														<xsl:value-of select="concat('Pri_',@moduleID)"/>
													</xsl:attribute>
													...
													<xsl:if test="@tag=902">
														<xsl:attribute name="onpropertychange">
															<xsl:value-of select="'checkedChange()'"/>
														</xsl:attribute>
													</xsl:if>
												</input>
											</div>
										...
										<!--菜单名称-->
										<td width="100%">
											<!-- <nobr class="MenuItem" onclick="event.srcElement.parentElement.previousSibling.firstChild.firstChild.click()"> -->
											<nobr class="MenuItem">
